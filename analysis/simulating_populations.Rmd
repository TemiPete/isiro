...
```{r}
source('https://raw.githubusercontent.com/TemiPete/miscellaneous_code/main/R/misc_functions.R')
```
...
The plot is approximately what we expect!
...
```{r}
pca_12 <- pca_dt$x[rownames(pca_dt$x) %in% c('population_1', 'population_2'), ]
plot(pca_12[, 'PC1'], pca_12[, 'PC2'], col=rownames(pca_12) |> as.factor(), bg=rownames(pca_12) |> as.factor(), xlab = 'PC1', ylab = 'PC2', frame.plot = F, pch=19)
```
